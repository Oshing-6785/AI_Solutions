...
module.exports.getAllGalleries = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Galleries retrieved", galleries });
  } catch (error) {
...
module.exports.getRecentGalleries = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Recent galleries retrieved", galleries });
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
...
module.exports.getGalleryById = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Gallery retrieved", gallery });
  } catch (error) {
...
module.exports.deleteGallery = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Gallery deleted", gallery: deletedGallery });
  } catch (error) {
    res.status(400).json({ error: error.message });
  }
};
