...
router.post(
  ...
  [
    ...
    body("company_name")
      ...
      .withMessage("Company name must be 1-300 characters"),
    ...
    body("duration")
      ...
      .withMessage("Invalid selected Time Duration"),
    ...
    body("team_size")
      ...
      .withMessage("Invalid team member selected"),

    body("key_results")
      .optional()
      .isArray()
      .withMessage("key_results must be an array of strings"),

    body("technologies_used")
      .optional()
      .isArray()
      .withMessage("technologies_used must be an array of strings"),
    ...
    body("process")
      ...
      .withMessage("Please select a valid process"),

    body("date")
      .optional()
      .isArray()
      .withMessage("Date must be array of string"),
